...
| **Home rule** | None — strong Dillon's Rule; § 21-17-5(2)(c) explicitly bars election procedure changes |
...
1. Section 21-17-5(2)(c) explicit bar on local election procedure changes
2. Firearms preemption with personal fines (Section 45-9-51)
3. No home rule authority to invoke

**Top Political Risks:**

1. Republican supermajority with no legislative pathway
2. "Second Amendment Preservation Act" proposed further preemption
3. Limited progressive infrastructure and coalition capacity
