---
title: Master Ordinance Template
description: >-
  Model language for municipal ordinances enforcing 18 U.S.C. § 592 and
  52 U.S.C. § 10307(b), with adaptation notes for all three tiers of states,
  legal strategy guidance, and optional provisions.
tags:
  - ordinance-template
  - 18-usc-592
  - model-legislation
...
**(c) "Election records"** means all ballots, poll books, voter registration records, tally sheets, chain-of-custody logs, and other documents used in the administration of elections within the [CITY NAME].
...
**(c) Affirmative Duty.** Municipal law enforcement personnel shall prioritize the protection of voters, poll workers, and election officials and shall take reasonable steps to ensure the orderly conduct of elections free from intimidation.
...
**(c)** When required by a valid court order issued by a court of competent jurisdiction, provided that the [CITY NAME] shall exhaust all available appeals before complying with any such order;
...
**(c) Redaction Requirements.** Any voter data lawfully disclosed in response to a federal request shall be redacted to remove all protected information as defined in subsection (a), unless a court order specifically requires disclosure of such information.
...
**(c) Notification of Breach Attempts.** The [CITY CLERK / APPROPRIATE OFFICIAL] shall immediately notify the [GOVERNING BODY], the [CITY ATTORNEY], and the [STATE CHIEF ELECTION OFFICIAL] if any individual or entity -- including a federal agency -- requests access to, attempts to access, or breaches the security of any voting system or election equipment.
...
**(c) Public Access.** The registry shall be published on the municipal website and updated within five business days of any new entry. Entries shall remain publicly accessible for at least five years.
...
**(c)** The [CITY NAME] reaffirms its commitment to complying with all valid federal law, including 18 U.S.C. § 592 and 52 U.S.C. § 10307(b), which prohibit armed presence at polling places and voter intimidation, respectively.
...
**(c) Public Notice.** The [CITY NAME] shall post a copy of this Ordinance at each polling place and on the municipal website during each election period.
...
## Legal Strategy: The "Federal Felony Exemption" Argument
...
### Tier 1 (GREEN) States -- Strongest Implementation Pathways

#### California

- Sanctuary state infrastructure (SB 54, California Values Act) provides legal and political cover
- Constitutional home rule under Art. XI, sections 5, 7 grants charter cities "all embracing" authority
- Frame as implementing California Values Act protections in the election context
- Targets: Los Angeles, San Francisco, San Jose, Oakland
- Protected zone distance can be expansive; strong enforcement language viable

#### Illinois

- Constitutional home rule (Art. VII, section 6) automatically applies to cities over 25,000 -- currently 224 municipalities
- Illinois Trust Act establishes precedent for protective non-cooperation policies
- Frame as extension of Trust Act protections to election integrity
- Targets: Chicago, Aurora, Evanston

#### Oregon

- Pure home rule -- all 241 cities operate under constitutional home rule (Art. XI, section 2)
- Portland reaffirmed sanctuary status 2025 with legal defense funds
- Frame as pure home rule authority over local affairs; resource management only
- Targets: Portland, Eugene, Salem

#### Washington

- Constitutional home rule since 1889 for first-class cities (10,000+)
- Seattle operates as sanctuary city with legal defense infrastructure
- Reference SB 5014 (2025) as model for network isolation provisions
- Frame under Art. XI, section 11 authority over local affairs
- Targets: Seattle, Tacoma

#### Michigan (Best Swing State Opportunity)

- 1963 Constitution provides robust home rule with liberal construction mandate
- Proposal 2 (2022) enshrined local election administration authority in state constitution
- No statewide anti-sanctuary law (legislation pending but not enacted)
- Tie directly to Proposal 2 election integrity protections
- Frame under Art. VII, section 22 municipal personnel authority
- Targets: Ann Arbor (test case), Detroit (maximum impact), Lansing

#### Colorado

- Constitutional home rule since 1902 (Art. XX, section 6); no anti-sanctuary laws
- Denver operates as "Welcoming City" with legal defense funds
- Targets: Denver, Aurora, Boulder

#### New York

- Strong constitutional home rule under Art. IX; Municipal Home Rule Law section 10
- NYC has robust legal capacity for defending local ordinances
- Can leverage Municipal Home Rule Law mechanism for community-specific adoption
- Targets: New York City, Buffalo, Albany

#### Minnesota

- Dillon's Rule but optional home rule charter available under Art. XII, sections 3-5
- Multiple sanctuary counties (Hennepin, Ramsey); Minneapolis sanctuary since 2003
- Reference Minn. Const. Art. XII, section 4 in preamble
- Nathan is registered lobbyist -- direct advocacy capability
- Targets: Minneapolis, St. Paul

#### Ohio

- Constitutional home rule since 1912 (Art. XVIII, sections 1-14); no anti-sanctuary laws
- Cleveland sanctuary resolution since 1987; Cincinnati declared sanctuary 2017
- Strong home rule precedent supports broad ordinance language
- Targets: Cleveland, Cincinnati, Columbus

#### Additional Tier 1 States

- **Massachusetts**: Constitutional home rule under Amendment Art. 89. Targets: Boston, Cambridge, Worcester
- **New Jersey**: Statutory home rule with liberal construction mandate. Targets: Newark, Jersey City
- **New Mexico**: Strong home rule (Art. X, section 6). Targets: Albuquerque, Santa Fe
- **Maryland**: Tiered home rule. Targets: Baltimore, Montgomery County
- **Maine**: Strong constitutional home rule (Art. VIII, Part 2, section 1). Targets: Portland, Lewiston
- **Rhode Island**: Constitutional home rule (Art. XIII). Target: Providence
- **Connecticut**: Constitutional home rule (Art. X). Targets: New Haven, Hartford, Bridgeport
- **Alaska**: Strong home rule (Art. X, section 11). Targets: Anchorage, Juneau

### Tier 2 (YELLOW) States -- Viable with Careful Framing

#### Pennsylvania

- Constitutional home rule option since 1972 (Art. IX, section 2); 79 municipalities with home rule charters
- Caution: *Crawford v. Commonwealth* (2024) upheld firearms preemption -- distinguish this ordinance from firearms regulation
- Cite PA Const. Art. I, section 5: "Elections shall be free and equal; and no power, civil or military, shall at any time interfere to prevent the free exercise of the right of suffrage"
- Targets: Pittsburgh (preferred initial target), Philadelphia (riskier after Crawford)

#### Nevada

- Modified Dillon's Rule; no constitutional home rule
- Complication: Governor Lombardo (R) signed DOJ agreement removing Nevada from sanctuary list
- Wait for 2026: if AG Ford defeats Lombardo, environment shifts dramatically
- Target: Las Vegas (post-2026 election)

#### Wisconsin (Most Challenging Swing State)

- Constitutional home rule (1924) interpreted very narrowly
- Anti-sanctuary ban (Walker, 2019); DHS designated Madison, Milwaukee as sanctuary jurisdictions (May 2025)
- Milwaukee derives 14% of revenue from federal funds -- significant vulnerability
- Avoid "sanctuary" terminology entirely; frame as resource allocation and local election administration
- Wait for Act 10 litigation outcome -- portions struck down December 2024
- Target: Madison only; Nathan is registered lobbyist in WI

#### Other Tier 2 States

- **Delaware**: Statutory home rule (municipal)/Dillon's (counties). Target: Wilmington
- **Hawaii**: Dillon's Rule (counties only). Target: Honolulu
- **Kansas**: Strong home rule since 1961. Targets: Kansas City, Lawrence
- **Kentucky**: Dillon's Rule. Targets: Louisville, Lexington
- **Louisiana**: Hybrid. Target: New Orleans (existing sanctuary)
- **Nebraska**: Hybrid. Targets: Omaha, Lincoln
- **New Hampshire**: Strict Dillon's Rule. Targets: Manchester, Nashua
- **South Carolina**: Home rule (Dillon's abolished 1993). Targets: Charleston, Columbia
- **Utah**: Strong home rule. Target: Salt Lake City
- **Vermont**: Strict Dillon's Rule. Target: Burlington

### Tier 3 (RED) States -- Significant Legal Barriers

These states have enacted anti-sanctuary laws with penalties ranging from funding cuts to felony criminal charges. Implementation is not recommended without prior legal challenge to anti-sanctuary statutes or significant political change.

**Key barriers by state:**

- **Tennessee**: SB 6002 (2025) -- felony charges (1-6 years imprisonment) for officials who vote for sanctuary policies
- **Texas**: SB 4 (2017) -- daily fines up to $25,500, Class A misdemeanor, removal from office
- **Arizona**: SB 1487 (2016) -- any single legislator can trigger investigation leading to withholding of all state-shared revenues
- **Georgia**: HB 301 (2024) -- any resident can sue, sovereign immunity rescinded, funding cessation, removal from office
- **Florida**: SB 168 (2019) -- mandatory E-Verify, anti-sanctuary enforcement

**Red states list:** Alabama, Arizona, Arkansas, Florida, Georgia, Idaho, Indiana, Iowa, Mississippi, Missouri, Montana, North Carolina, North Dakota, Oklahoma, South Dakota, Tennessee, Texas, Virginia, West Virginia, Wyoming

### Swing State Strategic Notes

**Arizona:** Wait for 2026 results. If Democrats retain Governor/AG, implement in Phoenix and Tucson in early 2027. Frame as 18 U.S.C. § 592 compliance, not immigration-related. Multiple cities passing simultaneously spreads SB 1487 targeting risk.

**Georgia:** Atlanta is the only viable target given resources for legal defense. Frame as personnel management/worker safety to avoid triggering the constitutional exclusion of "elections and appointments" from home rule. Prepare for immediate legislative response.

**North Carolina:** Durham is the only viable target. Frame as personnel management under G.S. 160A-174. Expect immediate legislative preemption. Consider whether establishing precedent is worth certain override.

## Coalition Building (Pre-Adoption Checklist)

Before any city adopts the ordinance, coordinate with:

- **Legal Organizations**: ACLU, Brennan Center for Justice, Georgetown Institute for Constitutional Advocacy and Protection
- **Election Protection Groups**: Common Cause, League of Women Voters, Lawyers' Committee for Civil Rights Under Law
- **Municipal Associations**: U.S. Conference of Mayors, National League of Cities
- **Academic Experts**: Constitutional law faculty for litigation support and amicus briefs
- **Veteran Groups**: Frame as protecting democratic process military members fought for
...
(c) It shall be a violation of municipal policy for any person to threaten, intimidate, or coerce any election worker with the intent to interfere with the performance of their duties.

### Funding Resilience Provision (Recommended for Jurisdictions with Federal Funding Exposure)
...
### Risk-Limiting Audit Provision (Recommended for Jurisdictions Seeking to Preempt Federal Audit Demands)
