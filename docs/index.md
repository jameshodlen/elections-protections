...
-   :material-city-variant:{ .lg .middle } **Municipal Officials & Lobbyists**
    ...
    Determine whether your city has legal authority to adopt a polling place
    protection ordinance under your state's home rule framework. Access
    model ordinance language with 14 operative sections covering resource
    allocation, voter data protection, election equipment custody, and
    transparency requirements.

    **Start:** Find your state guide for home rule analysis and target
...
-   :material-scale-balance:{ .lg .middle } **Attorneys & Legal Advocates**
    ...
    Access the "federal felony exemption" argument — the ordinance's
    strongest legal defense, distinct from traditional sanctuary city
    theories. Review the anti-commandeering doctrine framework,
    Supremacy Clause analysis, and three-phase litigation strategy
    for pre-election injunctive relief in state courts.

    **Start:** The ICE at Polling Places analysis for the federal
...
-   :material-account-group:{ .lg .middle } **Coalition Organizers**
    ...
    Access the 50-state strategic overview with GREEN/YELLOW/RED tier
    classifications, target city rankings by council composition and
    political dynamics, and coalition partner directories with contact
    information for legal organizations, election protection groups,
    civil rights organizations, labor unions, and municipal associations.
...
-   :material-check-circle:{ .lg .middle } **Tier 1 — Strong Viability (16 States)**
    ...
    political environments. These states have the clearest legal pathways
...
-   :material-alert-circle:{ .lg .middle } **Tier 2 — Proceed with Caution (11 States)**
    ...
    constraints, or complex political environments. Each state guide
...
-   :material-close-circle:{ .lg .middle } **Tier 3 — Significant Barriers (23 States)**
    ...
    Anti-sanctuary laws with penalties ranging from funding cuts to
    **felony charges** for local officials (Tennessee SB 6002: 1-6 years
    imprisonment; Texas SB 4: daily fines up to $25,500). Strategic
