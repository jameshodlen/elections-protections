...
**Prepared for 2026 Election Security Planning**
**January 2026**
...
1. **The Insurrection Act does NOT override 18 U.S.C. § 592**: Even troops deployed under the Insurrection Act remain subject to all other federal laws, including the prohibition on armed personnel at polling places.

2. **The Supreme Court has significantly constrained deployment authority**: *Trump v. Illinois* established that the president cannot federalize the National Guard under 10 U.S.C. § 12406 without demonstrating that regular military forces are unable to execute the laws—and that the military must be legally authorized to do so under the Posse Comitatus Act.

3. **Insurrection Act reform legislation is pending**: S. 2070 would require congressional approval within 7 days and create explicit judicial review mechanisms—though passage is unlikely in the current Congress.

4. **Your ordinance operates in a legally complementary space**: It doesn't purport to stop federal deployments; it simply directs municipal resources away from facilitating activities that would constitute federal crimes regardless of the deployment authority invoked.
...
1. **"Regular forces" means the military**: The statute allowing the president to call up the National Guard when he "is unable with the regular forces to execute the laws" applies only when the *regular military* is unable to restore order—not merely when civilian federal agents face resistance.

2. **Deployment must be legally authorized**: The President can only federalize the Guard "where the military could legally execute the laws." If the Posse Comitatus Act bars military law enforcement, the Guard cannot be deployed under § 12406.

3. **Factual predicates are judicially reviewable**: The Court rejected the government's claim of unreviewable presidential discretion, finding that courts may examine whether conditions actually justify deployment.
...
1. **Courts will review deployment predicates**: The administration cannot simply assert "rebellion" or "insurrection" without factual support.

2. **Gubernatorial consent effectively required**: For § 12406 deployments, the state's refusal creates a near-insurmountable barrier.

3. **The Insurrection Act is not a blank check**: Even if formally invoked, deployment must still comply with other federal laws.
...
**Lead Sponsors**: Sen. Blumenthal (CT), Rep. Deluzio (PA)
**Co-Sponsors**: 22 Democratic senators

**Key Provisions:**

1. **7-Day Automatic Termination**: Authority expires unless Congress passes joint resolution of approval
2. **14-Day Extensions**: Requires new congressional vote for each extension
3. **24-Hour Mandatory Reporting**: President must justify deployment to Congress immediately
4. **"Last Resort" Requirement**: Armed forces may only be used if civilian authorities are "physically unable" to address situation
5. **Explicit Judicial Review**: Creates express right for individuals, states, or local governments to sue
6. **Habeas Corpus Protection**: Explicitly bars suspension under the Act
7. **Standing Rules for Use of Force**: Requires compliance with existing military engagement rules
...
1. **You're not claiming to stop federal operations**: The ordinance directs municipal resources—it doesn't purport to prevent federal agents from acting independently.

2. **You're enforcing federal law**: The ordinance grounds itself in compliance with 18 U.S.C. § 592 and 52 U.S.C. § 10307(b). You're helping federal law be enforced.

3. **The Insurrection Act doesn't override your authority**: Even under Insurrection Act deployment, federal forces cannot lawfully operate at polling places.

4. **Anti-commandeering doctrine applies**: *Printz v. United States* protects local governments from being compelled to facilitate federal enforcement—especially federal crimes.
...
1. "Federal law—18 U.S.C. § 592—makes it a felony to deploy armed personnel at polling places. We're ensuring our city doesn't facilitate federal crimes."

2. "The Insurrection Act authorizes deployment to suppress insurrection. It does not authorize deployment to suppress voting."
...
Given your lobbying registration in Minnesota and the current Minneapolis crisis, there's a strategic opportunity:
...
1. **18 U.S.C. § 592 has no Insurrection Act exception**
2. **Courts are actively reviewing deployment authority** (*Trump v. Illinois*)
3. **Anti-commandeering doctrine protects local non-cooperation**
4. **Your framing—federal law compliance—is legally accurate**

### Implementation Timeline

**Phase 1 (Now - March 2026)**: Pass ordinances in Tier 1 states before primary elections begin

**Phase 2 (April - August 2026)**: Expand to Tier 2 states and swing state cities

**Phase 3 (September - October 2026)**: Legal defense preparation; rapid-response team activation

**Phase 4 (November 2026)**: Election week monitoring and enforcement

### Critical Next Steps

1. **Incorporate Insurrection Act analysis into ordinance preamble** — strengthens legal foundation

2. **Coordinate with state AGs** — particularly Ellison (MN), Bonta (CA), James (NY), Nessel (MI)

3. **Build litigation coalition** — Brennan Center, States United, ACLU, Georgetown ICAP

4. **Develop rapid-response legal team** — pre-positioned for Election Day TRO filings

5. **Public education campaign** — 18 U.S.C. § 592 awareness; voter rights under federal law

6. **Minnesota focus** — the current crisis creates immediate opportunity for your lobbying work
